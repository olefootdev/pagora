...
const ProvidersMap = ({ go }: ScreenProps) => {
  ...
  return (
    <div
      className="pg-screen"
      data-screen-label="A8 Mapa de prestadores"
...
// NOTIFICATIONS
// =====================================================================
const Notifications = ({ go }: ScreenProps) => {
  const items = [
    {
      id: 1,
      type: 'proposal',
      ...
      color: 'var(--green-700)',
      bg: 'var(--green-50)',
      t: 'Nova proposta recebida',
      s: 'JM Transportes ofereceu R$ 240 pelo seu pedido #PG-1247',
      time: 'Agora',
      unread: true,
    },
    {
      ...
      bg: 'var(--orange-50)',
      t: 'Carlos está a caminho',
      s: 'Chegada estimada em 12 min · pedido #PG-1247',
      time: 'Há 5 min',
      unread: true,
    },
    {
      ...
      color: 'var(--night-900)',
      bg: 'var(--ink-100)',
      t: 'Você ganhou R$ 30 de cashback',
      s: 'Indicação aprovada de Pedro Henrique',
      time: 'Há 2h',
      unread: true,
    },
    {
      ...
      color: 'var(--ink-700)',
      bg: 'var(--ink-100)',
      t: 'Atualização nos termos de uso',
      s: 'Pequenas mudanças nas regras de cancelamento',
      time: 'Ontem',
    },
    {
      id: 5,
      ...
      t: 'Avalie seu último serviço',
      s: 'Caçamba retirada por Lúcia há 3 dias',
      time: 'Há 3 dias',
    },
  ];
  return (
    <div className="pg-screen" data-screen-label="A9 Notificações">
      ...
      <div className="pg-viewport" style={{ paddingBottom: 80 }}>
        <div style={{ padding: '16px 20px 20px' }}>
          <div className="pg-h-eyebrow" style={{ marginBottom: 8 }}>
            HOJE
          </div>
          <div className="pg-stack pg-stack--sm">
          ...
          <div className="pg-h-eyebrow" style={{ marginTop: 24, marginBottom: 8 }}>
            ANTERIORES
          </div>
          <div className="pg-stack pg-stack--sm">
            {items.slice(3).map((n) => (
...
// FAVORITES
// =====================================================================
const Favorites = ({ go }: ScreenProps) => {
  const groups = [
    {
      neighborhood: 'Pinheiros · seu bairro',
      items: [
        {
          id: 1,
          name: 'Carlos Mudanças',
                  ...
                  <div key={p.id} className="pg-card pg-card--padded">
                    <div className="pg-row" style={{ gap: 12 }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div
                          className="pg-mono"
                          style={{ fontSize: 11, color: 'var(--text-mute)', marginTop: 4 }}
                        >
                          Último: {p.lastUsed}
                        </div>
                      </div>
...
// =====================================================================
const Addresses = ({ go }: ScreenProps) => {
  const items = [
    {
      id: 1,
      label: 'Casa',
      addr: 'Rua Augusta, 500, ap. 31, Consolação',
      icon: 'home',
      primary: true,
    },
    {
      id: 2,
      label: 'Trabalho',
      addr: 'Av. Paulista, 1000, 12º andar, Bela Vista',
      icon: 'building',
    },
    { id: 3, label: 'Casa da mãe', addr: 'Rua dos Pinheiros, 250, Pinheiros', icon: 'heart' },
    {
      id: 4,
      label: 'Obra Vila Madalena',
      addr: 'Rua Aspicuelta, 88, Vila Madalena',
      icon: 'wrench',
    },
  ];
  return (
            ...
            {items.map((it) => (
              <div key={it.id} className="pg-card pg-card--padded">
                <div className="pg-row" style={{ gap: 12 }}>
                  ...
                  <button className="pg-iconbtn" aria-label="Editar">
...
const Refer = ({ go }: ScreenProps) => {
  ...
  return (
    <div className="pg-screen" data-screen-label="A12 Indicar amigo">
      ...
      <div className="pg-viewport">
        <div
          style={{ padding: '20px 20px 30px', display: 'flex', flexDirection: 'column', gap: 18 }}
        >
          {/* Hero */}
          <div
            className="pg-card pg-card--dark"
            style={{ padding: 24, position: 'relative', overflow: 'hidden', textAlign: 'center' }}
          >
            <div
              style={{
                position: 'absolute',
                inset: 0,
                background:
                  'radial-gradient(circle at 50% 0%, rgba(34,227,163,0.18), transparent 60%)',
              }}
            />
            <span
              style={{
          ...
          <div className="pg-card pg-card--padded">
            <div className="pg-h-eyebrow" style={{ margin: 0, marginBottom: 8 }}>
              SEU CÓDIGO
            </div>
            <div
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8 }}>
            {[
              ...
              <div key={l} className="pg-card" style={{ padding: 14, textAlign: 'center' }}>
                ...
                <div className="pg-h-eyebrow" style={{ margin: '4px 0 0', fontSize: 9 }}>
                  {l}
                </div>
              </div>
            ))}
          ...
          <div>
            ...
            <div className="pg-stack pg-stack--sm">
              {friends.map((f) => {
                const statusMap: Record<string, { color: string; bg: string; t: string }> = {
                  completed: {
                    color: 'var(--green-700)',
                    bg: 'var(--green-50)',
                    t: 'Pedido concluído',
                ...
                const status = statusMap[f.status] ?? { color: '', bg: '', t: '' };
                return (
                      ...
                      {f.reward && (
                        <span
                          ...
                          style={{
                            ...
                            fontWeight: 700,
                            color:
                              f.status === 'completed' ? 'var(--green-700)' : 'var(--text-mute)',
                          }}
                        >
...
const Profile = ({
  go,
}: ScreenProps & { fontScale?: number; setFontScale?: (n: number) => void }) => {
  const sections = [
    {
      label: 'Conta',
      items: [
        ...
        >
          ...
          >
            ...
            >
              <div
                className="pg-mono"
                style={{ fontSize: 18, fontWeight: 700, color: 'var(--green-700)' }}
              >
                R$ 47
              </div>
              <div className="pg-h-eyebrow" style={{ margin: 0, fontSize: 9 }}>
...
// WALLET
// =====================================================================
const Wallet = ({ go }: ScreenProps) => {
  const transactions = [
    { t: 'Cashback · Frete #PG-1247', v: 4.2, date: 'Hoje', positive: true },
    { t: 'Indicação · Pedro Henrique', v: 30.0, date: 'Há 2 dias', positive: true },
    { t: 'Usado em Caçamba #PG-1183', v: -15.0, date: 'Há 1 semana' },
    { t: 'Cashback · Caçamba #PG-1183', v: 8.4, date: 'Há 1 semana', positive: true },
    { t: 'Bônus de boas-vindas', v: 20.0, date: 'Há 2 meses', positive: true },
  ];
  return (
          ...
          <div className="pg-card pg-card--padded">
            ...
            <div className="pg-row pg-row--between" style={{ alignItems: 'baseline' }}>
              <div className="pg-mono" style={{ fontSize: 22, fontWeight: 700 }}>
                R$ 12,60
                <span style={{ color: 'var(--text-mute)', fontSize: 14, fontWeight: 500 }}>
                  {' '}
                  / 50,00
                </span>
              </div>
              <span className="pg-tag pg-tag--green" style={{ fontSize: 9 }}>
                +R$ 4,20 ESTA SEMANA
              </span>
            </div>
            <div
            ...
            <div
              style={{ fontSize: 12, color: 'var(--text-soft)', marginTop: 10, lineHeight: 1.5 }}
            >
              Faça mais <strong>R$ 1.870 em pedidos</strong> esse mês para virar{' '}
              <strong>nível Ouro</strong> (4% de cashback).
            </div>
          </div>
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      fontSize: 14,
                      fontWeight: 700,
                      color: tx.positive ? 'var(--green-700)' : 'var(--text)',
                    }}
                  >
...
// HISTORY LIST
// =====================================================================
const HistoryList = ({ go }: ScreenProps) => {
  const [tab, setTab] = useStateB<'active' | 'past'>('active');
  const orders = {
    active: [
      {
        id: 'PG-1247',
  ...
  return (
    <div className="pg-screen" data-screen-label="A15 Histórico">
      ...
      >
        <div className="pg-segmented">
          <button
            className={`pg-segmented-item${tab === 'active' ? ' is-active' : ''}`}
            onClick={() => setTab('active')}
          >
            Em andamento (1)
          </button>
          <button
            className={`pg-segmented-item${tab === 'past' ? ' is-active' : ''}`}
            onClick={() => setTab('past')}
          >
            Anteriores
          </button>
          ...
          {list.length === 0 ? (
            ...
            <div className="pg-stack pg-stack--sm">
              {list.map((o) => (
                <button
                  key={o.id}
                  onClick={() => (o.status === 'Em andamento' ? go('tracking') : go('receipt'))}
                  className="pg-card pg-card--padded"
                  style={{
                    textAlign: 'left',
                    cursor: 'pointer',
                ...
                >
                  <div className="pg-row pg-row--between">
                    ...
                    <span
                      className="pg-mono"
                      style={{ fontSize: 11, color: 'var(--text-mute)', letterSpacing: '0.08em' }}
                    >
                      #{o.id}
                    </span>
                  </div>
...
// RECURRING
// =====================================================================
const Recurring = ({ go }: ScreenProps) => {
  const active = [
    {
      t: 'Caçamba semanal · Obra Vila Madalena',
      freq: 'Toda segunda',
      price: 'R$ 280',
      next: 'Próxima: 04 mai',
    },
          ...
          <div className="pg-card pg-card--soft" style={{ padding: 16 }}>
            <div className="pg-row" style={{ gap: 10, alignItems: 'flex-start' }}>
              ...
              <div style={{ fontSize: 13, color: 'var(--text-soft)', lineHeight: 1.5 }}>
                Programe pedidos que se repetem. Você confirma cada um por WhatsApp 1 dia antes —
...
// JOINT — dividir frete
// =====================================================================
const Joint = ({ go }: ScreenProps) => {
  const matches = [
    {
      name: 'Pedro M.',
      route: 'Vila Madalena → Pinheiros',
      date: 'Hoje 14:00',
      split: 'R$ 95 cada',
      initials: 'PM',
    },
      ...
      <div className="pg-viewport">
        ...
        >
          <div className="pg-card pg-card--dark" style={{ padding: 22 }}>
            ...
            <p
              style={{ color: 'rgba(255,255,255,0.65)', fontSize: 14, margin: 0, lineHeight: 1.5 }}
            >
              Conecta clientes com origem ou destino próximos no mesmo dia. O prestador faz uma
              viagem só, vocês dividem o valor.
            </p>
          </div>
            ...
            <div className="pg-stack pg-stack--sm">
              {matches.map((m) => (
                <div key={m.name} className="pg-card pg-card--padded">
                  ...
                  <button
                    className="pg-btn pg-btn--ghost pg-btn--sm pg-btn--block"
                    style={{ marginTop: 12 }}
                  >
          ...
          <div className="pg-card pg-card--soft" style={{ padding: 14 }}>
            <div className="pg-row" style={{ gap: 10 }}>
              ...
              <div style={{ fontSize: 12, color: 'var(--text-soft)', lineHeight: 1.5 }}>
                Você só paga depois que confirma o serviço. PAGORA media as conversas até o pedido
                ser fechado.
              </div>
            </div>
          </div>
...
const AccessibilityToggle = ({
  ...
  >
    <div className="pg-row" style={{ gap: 12, alignItems: 'center' }}>
      ...
      <span
        className="pg-toggle"
        style={{ background: on ? 'var(--green-600)' : 'var(--ink-300)' }}
      >
        <span
...
const Accessibility = ({ go }: ScreenProps) => {
        ...
        >
          <div className="pg-card pg-card--soft" style={{ padding: 16 }}>
            <p style={{ fontSize: 14, color: 'var(--text-soft)', margin: 0, lineHeight: 1.55 }}>
              A PAGORA foi pensada para todos. Ajustes que facilitam o uso por idosos, baixa visão
              ou em situações difíceis.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="pg-stack pg-stack--sm">
              <Toggle
                ...
                set={setLargeFont}
                title="Fonte maior"
                sub="Aumenta todos os textos do app em 25%"
                icon="edit"
              />
              <Toggle
                on={highContrast}
                ...
                sub="Cores mais fortes para melhor leitura sob sol forte"
                icon="sun-on"
              />
              <Toggle
                on={reduceMotion}
          ...
          <div>
            ...
            >
              <div style={{ fontWeight: 700, fontSize: largeFont ? 20 : 16 }}>
                Pedido confirmado
              </div>
          ...
          <div>
            ...
            <div className="pg-stack pg-stack--sm">
              <Toggle
                ...
                sub="O app lê o conteúdo das telas"
                icon="headset"
              />
              <button
                className="pg-card pg-card--padded"
